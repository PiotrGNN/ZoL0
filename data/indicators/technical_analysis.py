...
def compute_ichimoku(df: pd.DataFrame, conversion_line_period: int = 9, base_line_period: int = 26, leading_span_b_period: int = 52, displacement: int = 26) -> pd.DataFrame:
    """
