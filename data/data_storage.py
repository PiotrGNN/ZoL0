...
class DataStorage:
    ...
    def update_record(self, table_name: str, update_values: dict, conditions: str):
        ...
        try:
            ...
            self.conn.commit()
            logging.info("Zaktualizowano rekordy w tabeli %s przy warunkach: %s", table_name, conditions)
        except Exception as e:
    ...
    def delete_record(self, table_name: str, conditions: str):
        ...
        try:
            ...
            cursor.execute(sql)
            self.conn.commit()
            logging.info("Usunięto rekordy z tabeli %s przy warunkach: %s", table_name, conditions)
        except Exception as e:
...
if __name__ == "__main__":
    try:
        ...
        ds.update_csv(csv_file, headers, rows + [["2023-01-01 00:02:00", "16580", "16650", "16560", "16620", "400.0"]])
