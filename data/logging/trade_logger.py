...
class TradeLogger:
    def __init__(self, log_buffer_size: int = 100, report_dir: str = "./reports"):
        ...
        logging.info("TradeLogger zainicjalizowany z buforem o rozmiarze %d.", self.log_buffer_size)
    ...
    def flush_logs(self):
        ...
        try:
            ...
            fieldnames = ["timestamp", "symbol", "action", "quantity", "price", "strategy", "order_id"]
...
if __name__ == "__main__":
    try:
        ...
        sample_trades = [
            {"symbol": "BTCUSDT", "action": "BUY", "quantity": 0.001, "price": 30000, "strategy": "breakout", "order_id": 101},
            {"symbol": "ETHUSDT", "action": "SELL", "quantity": 0.01, "price": 2000, "strategy": "mean_reversion", "order_id": 102},
            {"symbol": "BNBUSDT", "action": "BUY", "quantity": 0.5, "price": 250, "strategy": "trend_following", "order_id": 103},
            {"symbol": "BTCUSDT", "action": "SELL", "quantity": 0.001, "price": 31000, "strategy": "stop_loss", "order_id": 104},
            {"symbol": "ETHUSDT", "action": "BUY", "quantity": 0.02, "price": 2100, "strategy": "breakout", "order_id": 105}
        ]
