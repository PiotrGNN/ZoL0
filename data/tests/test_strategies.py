...
from data.strategies.base_strategy import BaseStrategy
from data.strategies.momentum_strategy import MomentumStrategy
from data.strategies.mean_reversion_strategy import MeanReversionStrategy
from data.strategies.trend_following_strategy import TrendFollowingStrategy
from data.strategies.volatility_strategy import VolatilityStrategy
...
class TestStrategies(unittest.TestCase):
    ...
    def test_trend_following(self):
        ...
        self.assertIn(signal.iloc[-1], [-1, 0, 1], "Sygnał powinien być -1, 0 lub 1")
