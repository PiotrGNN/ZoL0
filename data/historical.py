...
def compute_statistics(df: pd.DataFrame) -> dict:
    ...
    try:
        ...
        logging.info("Obliczono statystyki: średnia=%f, std=%f, max drawdown=%f",
                     stats['mean_close'], stats['std_close'], stats['max_drawdown'])
...
def generate_report(df: pd.DataFrame, stats: dict, chart_path: str, report_path: str,
